          ...
          {articles.map((article) => (
            ...
            >
              ...
              >
                ...
                <motion.h1 className="text-4xl font-bold pb-5 text-gray-500" initial={textColorAnimation.initial} whileInView={textColorAnimation.whileInView} viewport={textColorAnimation.viewport}>{article.title}</motion.h1>
